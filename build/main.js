...
/***/ function(module, exports, __webpack_require__) {
	...
	adminApp.directive('activeEntity', __webpack_require__(15));
	adminApp.directive('deactiveEntity', __webpack_require__(16));
	adminApp.directive('services', __webpack_require__(17));
	adminApp.directive('payment', __webpack_require__(18));
	adminApp.directive('addClient', __webpack_require__(19));
	adminApp.directive('geo', __webpack_require__(20));
	adminApp.directive('addNewTag', __webpack_require__(21));
	adminApp.directive('subdomain', __webpack_require__(22));
	adminApp.directive('showSubdomain', __webpack_require__(23));
	adminApp.directive('messages', __webpack_require__(24));
	adminApp.directive('deleteRoom', __webpack_require__(25));
	adminApp.directive('roommate', __webpack_require__(26));
	adminApp.directive('publishFacebook', __webpack_require__(27));
	adminApp.directive('upload', __webpack_require__(28));
	adminApp.directive('imagenes', __webpack_require__(29));
	...
	// custom states (pages)
	adminApp.config(['$stateProvider', __webpack_require__(30)]);
	adminApp.controller('chatController', __webpack_require__(32));
	adminApp.config(['$stateProvider', __webpack_require__(33)]);
	adminApp.controller('entityTagsController', __webpack_require__(35));
	adminApp.config(['$stateProvider', __webpack_require__(36)]);
	adminApp.controller('entityImagesController', __webpack_require__(38));
	
	adminApp.config(['NgAdminConfigurationProvider', function (nga) {
	
	  urlBase = "http://104.131.113.114:3004/api/";
	  //var urlBase = "/api/";
	  ...
	  admin.header(__webpack_require__(39));
	  ...
	  if (JSON.parse(localStorage.getItem('az_admin_user')).superuser) {
	    ...
	    __webpack_require__(41)(nga, admin);
	    __webpack_require__(42)(nga, admin);
	    __webpack_require__(43)(nga, admin);
	    __webpack_require__(44)(nga, admin);
	    __webpack_require__(45)(nga, admin);
	    __webpack_require__(46)(nga, admin);
	    __webpack_require__(47)(nga, admin);
	
	    admin.dashboard(__webpack_require__(48)(nga, admin));
	    admin.menu(__webpack_require__(153)(nga, admin));
	  } else {
	    // entity owner config
	    if (!JSON.parse(localStorage.getItem('az_admin_user')).entityId) {
	      ...
	      adminApp.config(['RestangularProvider', __webpack_require__(154).requestInterceptor]);
	...
	function entityImage($http) {
	  ...
	  return {
	    ...
	    link: function link(scope, elem, attrs) {
	      ...
	      console.log('URL', scope.entry.values);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _chatTemplateHtml = __webpack_require__(31);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _templateHtml = __webpack_require__(34);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _templateHtml = __webpack_require__(37);
...
/***/ function(module, exports) {
	...
	module.exports = "<div>\n\t<h1 style=\"\">Imágenes y pagina web</h1>\n\t<div class=\"row\">\n\t\t<div class=\"col-xs-6\">\n\t\t\t<h2>Logo de tu comercio</h2>\n\t\t\t<entity-image target=\"logo\" name=\"entity\"></entity-image>\t\n\t\t\t</div>\n\t\t<div class=\"col-xs-6\">\n\t\t\t<h2>Código QR</h2>\n\t\t\t<entity-image target=\"cover\" name=\"entity\"></entity-image>\n\t\t</div>\n\t</div>\n</div>\n";
...
/***/ function(module, exports) {
	...
	exports['default'] = function (nga, admin) {
	  return nga.menu().addChild(nga.menu().link('/usuarios/edit/' + JSON.parse(localStorage.getItem('az_admin_user')).userId).title('Usuario').icon('<span class="glyphicon glyphicon-user"></span>')).addChild(nga.menu().title('Perfil').icon('<span class="glyphicon glyphicon-list-alt"></span>').addChild(nga.menu().link('/entities/edit/' + JSON.parse(localStorage.getItem('az_admin_user')).entityId).title('General').icon('<span class="glyphicon glyphicon-edit"></span>')).addChild(nga.menu().link('/tags').title('Tags').icon('<span class="glyphicon glyphicon-tags"></span>')).addChild(nga.menu().link('/images').title('Imagenes').icon('<span class="glyphicon glyphicon-picture"></span>'))).addChild(nga.menu().link('/adverts/list').title('Publicaciones').icon('<span class="glyphicon glyphicon-th-large"></span>')).addChild(nga.menu(admin.getEntity('chatrooms')).title('Mensajes').icon('<span class="glyphicon glyphicon-envelope"></span>')).addChild(nga.menu(admin.getEntity('clients')).title('Clientes favoritos').icon('<span class="glyphicon glyphicon-star"></span>'));
	};
